...
import { addPlaces } from "../../api/PlaceApi";
...
export default function AddPlace() {
  ...
  const onSubmit = async (data) => {
    ...
    const placeRequest = await addPlaces(formData);
    if (placeRequest != null) {
      postSuccessToast("Thêm địa điểm thành công!");
      setTimeout(() => {
            ...
            <div className="col-sm mb-2 mb-sm-0">
              <nav aria-label="breadcrumb">
                <ol className="breadcrumb breadcrumb-no-gutter">
                  ...
                  <li className="breadcrumb-item active">Thêm địa điểm</li>
                </ol>
              </nav>
              <h1 className="page-header-title">Thêm địa điểm</h1>
            </div>
          </div>
        </div>
        {/* End Page Header */}
