...
import { getPageHotels } from "../../api/PublicApi";
...
const Hotels = () => {
  ...
  useEffect(() => {
    const fetchHotelList = async () => {
      const tmpHotels = await getPageHotels(currentPage, 8);
      if (tmpHotels != null) {
        setHotelsList(tmpHotels.content);
      ...
      <div className="content container-fluid w-90">
        <div className="row justify-content-center ">
          <div className="col-lg-10">
            <h1 className="text-center">Khách sạn</h1>
