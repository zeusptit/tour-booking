...
import { editTourGuideInfo } from "../../api/TourGuideApi";
import { postSuccessToast, postWarningToast } from "../../layouts/Toast";
import { useForm } from "react-hook-form";
function EditTourGuide(props) {
  const {
    register,
    handleSubmit,
    reset,
  ...
  if (isLoad === false && props.tourguideInfo) {
    reset(props.tourguideInfo);
    setIsLoad(true);
  }
  const onSubmit = async (data) => {
    const res = await editTourGuideInfo(data);
            ...
            <div id="addUserStepProfile" className="card card-lg active">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="card-footer d-flex justify-content-end align-items-center">
                  <Link className="btn btn-outline-danger mx-2" to="/tourguide">
